...
class Parameters:
    def __init__(self):
        ...
        #Rover domain
        self.dim_x = self.dim_y = 7; self.obs_radius = 15; self.act_dist = 0.1; self.angle_res = 45
        self.num_poi = 1; self.num_rover = 1; self.num_timestep = 10
        self.poi_rand = 1

        #Dependents
        self.state_dim = 1*360 / self.angle_res + 2
        self.action_dim = 2
        self.epsilon = 0.5
        self.alpha = 0.9
        self.gamma = 0.9
...
class Task_Rovers:
    ...
    def get_state(self, rover_id):
        ...
        state = np.zeros(((360 / self.params.angle_res)+2, 1))  # FORMAT: [bracket] = (drone_avg_dist, drone_number, food_avg_dist, food_number_item, reward ......]
